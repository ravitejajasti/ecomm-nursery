...
try:
    ...
    AWS_ACCESS_KEY_ID = os.environ.get("AWS_ACCESS_KEY_ID", "AKIAIIA66EO5DIOPCA2A")
    AWS_SECRET_ACCESS_KEY = os.environ.get("AWS_SECRET_ACCESS_KEY", "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")

AWS_GROUP_NAME = "django-vriksh"
AWS_USERNAME = "vriksh"
...
AWS_STORAGE_BUCKET_NAME = 'vriksh-static'
